...
public:
    ...
    void hire(Warrior& warriorName){
        if (warriorName.getJobStatus() == true){ // if the warrior is unhirired
    ...
    void battle(Noble& nobleName){
        ...
        if (isAlive == true && nobleName.aliveNow() == true)
        {
        ...
        else if (isAlive == false && nobleName.aliveNow() == false)
        {
            cout << "Oh, NO! They're both dead! Yuck!" << endl;
        }
        else if (isAlive == false && nobleName.aliveNow() == true)
        {
            cout << "He's dead, " << nobleName.getName() << "." << endl;
        }
        else if (isAlive == true && nobleName.aliveNow() == false)
        {
